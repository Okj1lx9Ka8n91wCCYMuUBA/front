			...
			<Content>
				...
				<div className='mt-5 bg-white p-[11px] rounded-[10px]'>
					...
					<div className='mt-[5px] text-[12px] font-light'>
						Молодёжный слёт «Поколение Z» – это образовательно-просветительская площадка
						для молодых представителей общественной и добровольческой сферы. Программа
						слёта ориентирована на представителей студенческой и трудовой молодёжи в
						возрасте от 18 до 35 лет, включённых в общественно-политические мероприятия
						своего региона. В рамках образовательных встреч будут обсуждены проблемы и
						достижения общественного сектора и роли молодёжи в его развитии. <br />
						<br />
						Слёт смогут посетить до 300 участников из всех федеральных округов
